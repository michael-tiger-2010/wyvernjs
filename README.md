...
<script src="https://cdn.jsdelivr.net/npm/@mchen_dragon/wyvernjs@latestmain/diwu.js"></script>
...
// All at once
import {dw, diwu, tf, tianfeng, fw, firewyrm, sh, shuihu} from 'https://cdn.jsdelivr.net/npm/@mchen_dragon/wyvernjs@latest/main/wyvern.js';
```
